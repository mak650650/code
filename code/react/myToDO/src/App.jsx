            ...
            <div className=" mx-10">
                ...
                <div className="w-full">
                        <div className=" h-20 flex justify-end">
                            <div>
                                <label className="m-3 ml-7 text-gray-400 text-sm">Filter</label>
                                <input 
                                type="search" 
                                name="" 
                                id="filter" 
                                placeholder="All" 
                                className="bg-neutral-900 px-3 py-2 rounded-lg shadow-lg border focus:outline-none border-neutral-900 focus:border-sky-700"/>
                            </div>
                            <div>
                                <label className="mr-3 ml-7 text-gray-400 text-sm">Sort</label>
                                <input 
                                type="text"
                                name="" 
                                id="sort" 
                                placeholder="Added date" 
                                className="bg-neutral-900 px-3 py-2 rounded-lg shadow-lg focus:outline-none border border-neutral-900  focus:border-sky-700"/>
                            </div>
                        </div>
                </div>
